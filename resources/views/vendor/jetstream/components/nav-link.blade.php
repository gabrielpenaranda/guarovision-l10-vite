...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-azul-900 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-azul-500 transition'
