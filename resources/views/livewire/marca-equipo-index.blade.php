<div class="container mx-auto py-4 max-w-2xl">
    <div class="flex pb-2 items-center justify-between">
        <h4 class="titulo">Marcas de Equipo</h4>
        @can('marca-equipo.create')
            <a href="{{ route('marca-equipo.create') }}" class="btn btn-new btn-xs sm:btn-sm mr-4">Nuevo</a>
        @endcan
    </div>
    <x-table>
                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col"
                            ...
                            wire:click="order('marca_equipo')">
                            Marca<sup><i class="fa-solid fa-magnifying-glass"></i></sup>

                            @if ($sort == 'marca_equipo')
                                @if ($direction == 'asc')
                    ...
                    @foreach ($marca_equipos as $marca_equipo)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-center">
                                @if (Auth::check())
                                    <form
                                        action="{{ route('marca-equipo.show-destroy', ['marca_equipo' => $marca_equipo->id]) }}"
                                        method='GET'>
                                        ...
                                        <div
                                            ...
                                            @can('marca-equipo.edit')
                                                <a class="btn btn-xs sm:btn-sm btn-edit"
                                                    href="{{ route('marca-equipo.edit', ['marca_equipo' => $marca_equipo->id]) }}"
