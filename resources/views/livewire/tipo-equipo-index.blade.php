<div class="container mx-auto py-4 max-w-2xl">
    <div class="flex pb-2 items-center justify-between">
        <h4 class="titulo">Tipos de Equipo</h4>
        @can('tipo-equipo.create')
            <a href="{{ route('tipo-equipo.create') }}" class="btn btn-new btn-xs sm:btn-sm mr-4">Nuevo</a>
        @endcan
    </div>
    <x-table>
                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col"
                            ...
                            wire:click="order('tipo_equipo')">
                            Tipo de Equipo<sup><i class="fa-solid fa-magnifying-glass"></i></sup>
                    ...
                    @foreach ($tipo_equipos as $tipo_equipo)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-center">
                                @if (Auth::check())
                                    <form
                                        action="{{ route('tipo-equipo.show-destroy', ['tipo_equipo' => $tipo_equipo->id]) }}"
                                        method='GET'>
                                        ...
                                        <div
                                            ...
                                            @can('tipo-equipo.edit')
                                                <a class="btn btn-xs sm:btn-sm btn-edit"
                                                    href="{{ route('tipo-equipo.edit', ['tipo_equipo' => $tipo_equipo->id]) }}"
