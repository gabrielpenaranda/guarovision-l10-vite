<div class="container mx-auto py-4 max-w-7xl">
    <div class="flex pb-2 items-center justify-between">
        <h4 class="titulo">Taquilla {{ $taquilla->taquilla }}</h4>
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-center">
                                @if (Auth::check())
                                    <div
                                        ...
                                        @can('pago.create')
                                            <a class="btn btn-xs sm:btn-sm btn-verde"
                                                href="{{ route('pago.create', ['cliente' => $cliente->id, 'taquilla' => $taquilla->id]) }}"
                                                title="Registrar pago"><i class="fa-regular fa-money-bill-1"></i></a>
                                        @endcan

                                        @can('cliente.cuenta')
                                            <a class="btn btn-xs sm:btn-sm btn-violeta mt-1 sm:mt-0 ml-0 sm:ml-1"
                                                href="{{ route('pago.cuenta', ['cliente' => $cliente->id, 'taquilla' => $taquilla->id]) }}"
