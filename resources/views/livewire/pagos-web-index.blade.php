<div class="container mx-auto py-4 max-w-7xl">
    <div class="flex pb-2 items-center justify-between">
        ...
        {{-- <div class="flex-col sm:flex-row inline-flex">
            @can('pago_web.lote')
                <a href="{{ route('pago_web.carga-lote') }}" class="btn btn-verde btn-xs sm:btn-sm mr-4">Cargar Lote</a>
            @endcan
            @can('pago_web.create')
                <a href="{{ route('pago_web.create') }}"
        ...
        <div class="px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex-1 mt-2 sm:mt-0 sm:ml-4">
                ...
                <select name="" id="" wire:model="criterio"
                    ...
                    <option value="4">Nº Referencia</option>
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col"
                            ...
                            referencia<sup><i class="fa-solid fa-magnifying-glass z-0"></i></sup>

                            @if ($sort == 'num_referencia')
                                @if ($direction == 'asc')
                                    <i class="fa-solid fa-arrow-up-a-z float-right mt-1"></i>
                                @else
                                    <i class="fa-solid fa-arrow-down-z-a float-right mt-1"></i>
                        ...
                        <th scope="col"
                            ...
                            wire:click="order('realizado_por')">
                            realizado por<sup><i class="fa-solid fa-magnifying-glass z-0"></i></sup>

                            @if ($sort == 'realizado_por')
                                @if ($direction == 'asc')
                                    <i class="fa-solid fa-arrow-up-a-z float-right mt-1"></i>
                                @else
                                    <i class="fa-solid fa-arrow-down-z-a float-right mt-1"></i>
                        ...
                        <th scope="col"
                            ...
                            cédula<sup><i class="fa-solid fa-magnifying-glass z-0"></i></sup>
