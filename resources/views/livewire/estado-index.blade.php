<div class="container mx-auto py-4 max-w-2xl">
    <div class="flex pb-2 items-center justify-between">
        <h4 class="titulo">Estados</h4>
        @can('estado.create')
            <a href="{{ route('estado.create') }}" class="btn btn-new btn-xs sm:btn-sm mr-4">Nuevo</a>
        @endcan
    </div>
    <x-table>
                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col"
                            ...
                            estado<sup><i class="fa-solid fa-magnifying-glass"></i></sup>
                    ...
                    @foreach ($estados as $estado)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-center">
                                @if (Auth::check())
                                    <form action="{{ route('estado.show-destroy', ['estado' => $estado->id]) }}"
                                        method='GET'>
                                        ...
                                        <div
                                            ...
                                            @can('estado.edit')
                                                <a class="btn btn-xs sm:btn-sm btn-edit"
                                                    href="{{ route('estado.edit', ['estado' => $estado->id]) }}"
