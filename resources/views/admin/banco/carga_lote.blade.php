...
@section('content')
    <div class="container mx-auto py-4 max-w-3xl">
        <div class="flex pb-2 items-center justify-between">
            ...
            <a class="btn btn-back btn-xs sm:btn-sm mr-4" href="{{ route('banco.movimiento') }}">Regresar</a>
        </div>

        <form action="{{ route('banco.procesa-lote') }}" enctype="multipart/form-data" method="POST">
            @csrf
